...
describe('SignUp Controller', () => {
  ...
  test('Should return 400, if an no valid email is provide', async () => {
  ...
  test('Should call EmailValidator with correct email is provided', async () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Should return AddAccount with correct values', async () => {
